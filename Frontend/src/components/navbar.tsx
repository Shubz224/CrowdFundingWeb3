...
export function Navbar() {
    ...
    return (
        <div className="flex md:flex-row flex-col-reverse justify-between mb-[35px] gap-6">
            <div className="lg:flex-1 flex flex-row max-w-[458px] py-2 pl-4 pr-2 h-[52px] bg-[#ECF1FF]
                rounded-[100px]
            ">
                ...
                />
                <div className="w-[72px] h-full rounded-[20px] bg-[#1A72E9] flex justify-center items-center cursor-pointer">
            ...
            <div className="sm:flex hidden flex-row justify-end gap-4">
                <CustomButton
                    ...
                    styles={address ? 'bg-[#1dc071]' : 'bg-[#1A72E9]'}
                    handleClick={() => {
